<?php
  ...
  try {
    ...
    foreach ($contacts as $contact) {
      ...
      //tax deductibe if financial type id is 5
      $isTaxDeductible = ($contribution && isset($contribution['financial_type_id']) && $contribution['financial_type_id'] === 5);
    ...
    function findExistingContact($contact, $contribution, $existingContactsMap) {
      $isTaxDeductible = ($contribution && isset($contribution['financial_type_id']) && $contribution['financial_type_id'] === 5);
    ...
    foreach ($contacts as $index => $contact) {
      ...
      try {
        $existingContact = findExistingContact($contact, $contribution, $existingContactsMap);
        $contactId = null;
